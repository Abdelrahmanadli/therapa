...
class _RegisterPageState extends State<RegisterPage> {
  ...
  UserType _selectedRegisterType = UserType.patient; // Default registration type
                                  ...
                                  children: [
                                    Expanded(
                                      child: ElevatedButton(
                                        onPressed: () {
                                          setState(() {
                                            _selectedRegisterType = UserType.patient;
                                          });
                                        },
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: _selectedRegisterType == UserType.patient ? primaryGreen : lightBackground,
                                          foregroundColor: _selectedRegisterType == UserType.patient ? Colors.white : primaryText,
                                          side: BorderSide(
                                            color: _selectedRegisterType == UserType.patient ? primaryGreen : secondaryText,
                                            width: 1.0,
                                          ),
                                    ...
                                    Expanded(
                                      child: ElevatedButton(
                                        onPressed: () {
                                          setState(() {
                                            _selectedRegisterType = UserType.therapist;
                                          });
                                        },
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: _selectedRegisterType == UserType.therapist ? primaryGreen : lightBackground,
                                          foregroundColor: _selectedRegisterType == UserType.therapist ? Colors.white : primaryText,
                                          side: BorderSide(
                                            color: _selectedRegisterType == UserType.therapist ? primaryGreen : secondaryText,
                                            width: 1.0,
                                          ),
                                          shape: RoundedRectangleBorder(
                                            borderRadius: BorderRadius.circular(12.0),
                                  ...
                                  onPressed: () async {
                                    ...
                                    try {
                                      ...
                                      if (userCredential.user != null) {
                                        ...
                                        await targetCollection.doc(userCredential.user!.uid).set(userData);
