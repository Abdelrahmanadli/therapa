...
const Color alternateColor = Color(0xFFE0E0E0); // A light grey for borders and inactive elements
...
class _AddTaskDialogState extends State<AddTaskDialog> {
  ...
  Set<int> _selectedRepeatDays = {}; // Stores selected weekdays for recurrence (1=Mon, ..., 7=Sun)
  ...
  Future<void> _addTaskToFirestore() async {
    ...
    Map<String, dynamic> taskData = {
      ...
      'details': detailsTextController.text.trim(), // Details can now be empty
      'taskDate': Timestamp.fromDate(DateTime(_selectedDate!.year, _selectedDate!.month, _selectedDate!.day)), // Normalize date to start of day
      'isRecurring': _selectedRepeatDays.isNotEmpty,
      'repeatDays': _selectedRepeatDays.toList(), // Store the list of selected weekdays
      'completed': false, // New tasks are always incomplete
      'userRef': userRef, // Reference to the user who created the task
      'created_at': FieldValue.serverTimestamp(), // Server timestamp for creation
    };
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Align(
                  alignment: AlignmentDirectional.topEnd, // Align close button to top-right
                  child: InkWell(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(color: alternateColor, width: 1.0), // Light grey border
                        borderRadius: BorderRadius.circular(12.0),
                      ),
                      focusedBorder: OutlineInputBorder(
                        borderSide: BorderSide(color: primaryGreen, width: 1.0), // Green when focused
                        borderRadius: BorderRadius.circular(12.0),
                      ),
                      ...
                      filled: true,
                      fillColor: lightBackground, // Light background fill
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    minLines: 3,
                    decoration: InputDecoration(
                      labelText: 'Details (Optional)...', // Changed label to indicate optional
                      labelStyle: GoogleFonts.inter(color: secondaryText),
                      enabledBorder: OutlineInputBorder(
                      ...
                      errorBorder: OutlineInputBorder( // Keep error styling for consistency, though no validator
                        borderSide: BorderSide(color: errorColor, width: 1.0),
                        borderRadius: BorderRadius.circular(12.0),
                      ),
                      focusedErrorBorder: OutlineInputBorder( // Keep error styling
                        borderSide: BorderSide(color: errorColor, width: 1.0),
                        borderRadius: BorderRadius.circular(12.0),
                      ),
                      filled: true,
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          final DateTime? picked = await showDatePicker(
                            ...
                            lastDate: DateTime.now().add(const Duration(days: 365 * 5)), // 5 years future
                              ...
                              return Theme(
                                data: ThemeData.light().copyWith(
                                  colorScheme: ColorScheme.light(
                                    ...
                                    surface: cardBackground, // Dialog background color
                        ...
                        child: Container(
                          ...
                          height: 40.0,
                          decoration: BoxDecoration(
                            color: primaryGreen, // Green background for calendar icon
                            borderRadius: BorderRadius.circular(8.0),
                          ),
                          child: const Icon(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: _weekdayNames.entries.map((entry) {
                      ...
                      final isSelected = _selectedRepeatDays.contains(weekday);
                      ...
                      return InkWell(
                        ...
                        borderRadius: BorderRadius.circular(8.0),
                        child: Container(
                          width: 35.0, // Fixed width for each day button
                          height: 35.0, // Fixed height for each day button
                          alignment: Alignment.center,
                          decoration: BoxDecoration(
                            color: isSelected ? primaryGreen : lightBackground,
                            borderRadius: BorderRadius.circular(8.0),
                            border: Border.all(
                              color: isSelected ? primaryGreen : alternateColor,
                              width: 1.0,
                            ),
                          ),
                          child: Text(
                ...
                ElevatedButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      _showAlertDialog('Validation Error', 'Please fill in all required fields (Title).');
                    }
                  },
                  style: ElevatedButton.styleFrom(
                    minimumSize: const Size(double.infinity, 50.0), // Full width, fixed height
                    backgroundColor: primaryGreen, // Green background
                    foregroundColor: cardBackground, // White text/icon
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(24.0), // Rounded button
                    ),
                    elevation: 0.0, // No elevation
                    side: BorderSide(color: alternateColor, width: 1.0), // Light grey border
                    padding: const EdgeInsets.symmetric(vertical: 12.0), // Padding around content
                  ),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      const Icon(Icons.add, size: 24.0), // Add icon
