...
class _TaskDetailsPageState extends State<TaskDetailsPage> {
  ...
  void initState() {
    ...
    titleTextController = TextEditingController(text: widget.taskDoc['title'] as String? ?? '');
    detailsTextController = TextEditingController(text: widget.taskDoc['details'] as String? ?? '');
  ...
  void _showAlertDialog(String title, String message, {bool isConfirmation = false, VoidCallback? onConfirm}) {
    showDialog(
      context: context,
  ...
  Future<void> _updateTask() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('tasks').doc(widget.taskDoc.id).update({
      ...
      if (mounted) {
        Navigator.pop(context); // Navigate back to TasksPage after successful update
      }
    } catch (e) {
  ...
  Future<void> _deleteTask() async {
    _showAlertDialog(
      ...
      onConfirm: () async {
        try {
          await FirebaseFirestore.instance.collection('tasks').doc(widget.taskDoc.id).delete();
          _showAlertDialog('Success', 'Task deleted successfully!');
          if (mounted) {
            Navigator.pop(context); // Go back to the previous screen (TasksPage) after deletion
          }
        } catch (e) {
          ...
          children: [
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                color: primaryGreen, // Changed app bar background to primaryGreen
                boxShadow: [
                  BoxShadow(
                    blurRadius: 5.0,
                    ...
                    Align(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: const Icon(
                            Icons.arrow_back,
                            color: primaryText, // White arrow icon for green background
                            size: 24.0,
                          ),
                        ),
                      ),
                      ...
                      child: Align(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.interTight(
                            ...
                            color: primaryText, // White text for green background
                          ),
                        ),
                      ),
                    ),
                        ...
                        InkWell(
                          ...
                          onTap: () {
                            setState(() {
                              ...
                              _autovalidateMode = false; // Reset autovalidation on toggle
                            });
                          },
                          child: Container(
                            width: 40.0,
                            ...
                            child: Icon(
                              _isEditing ? Icons.edit_off : Icons.edit, // Change icon based on editing mode
                              color: primaryText, // White icon for green background
                              size: 24.0,
                            ),
                          ),
                        ),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: const Icon(
                              ...
                              color: primaryText, // White icon for green background (image showed white icon)
                              size: 24.0,
                            ),
                          ),
                        ),
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            enabled: _isEditing, // Control editability
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            minLines: 3,
                            decoration: InputDecoration(
                              hintText: 'Details...', // Placeholder text
                              hintStyle: GoogleFonts.inter(color: secondaryText),
                              enabledBorder: OutlineInputBorder(
                                borderSide: BorderSide(color: alternateColor, width: 1.0),
                                borderRadius: BorderRadius.circular(12.0),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: _isEditing ? primaryGreen : alternateColor, // Green button
                                foregroundColor: cardBackground, // White text
