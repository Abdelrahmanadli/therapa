...
import 'package:therapa/login_page.dart';
import 'package:therapa/register_page.dart'; // For custom fonts
...
class _LandingPageState extends State<LandingPage> {
  ...
  static const Color primaryText = Color(0xFF14181B); // Assuming a dark text for primary
  static const Color secondaryText = Color(0xFF57636C); // For the body text
  static const Color alternateColor = Color(0xFF000000); // Used where FlutterFlowTheme.alternate was
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
              ...
              children: [
                Align(
                  ...
                  child: Padding(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(0.0), // No border radius as per original
                      child: Image.asset(
                        'assets/images/therapygirl.png', // Use the provided image asset
                        width: double.infinity, // Occupy full width
                        height: 400.0, // Fixed height for the image
                        fit: BoxFit.cover, // Cover the entire space
                        alignment: const Alignment(0.0, -1.0), // Align to top center
                      ),
                    ),
                  ),
                ),
                ...
                Container(
                  width: double.infinity, // Occupy full width
                  height: 450.0, // Height slightly more than image for gradient effect
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: const [Colors.transparent, lightBackground], // Transparent to background color
                      stops: const [0.0, 0.73], // Gradient starts from transparent at 0% and transitions to background color at 80%
                      begin: const AlignmentDirectional(0.0, -1.0), // Top to bottom
                      end: const AlignmentDirectional(0, 1.0),
                    ),
                    borderRadius: BorderRadius.circular(0.0), // No border radius
                  ),
                  child: Align(
                    alignment: const AlignmentDirectional(0.0, 1.0), // Align content to the bottom of this container
                    child: SingleChildScrollView(
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.center, // Center the icon and texts
                        children: [
                          Align(
                            alignment: const AlignmentDirectional(0.0, -1.0),
                            child: Icon(
                          ...
                          Align(
                            ...
                            child: Text(
                              'Theraputic',
                              style: GoogleFonts.playfairDisplay( // Custom font
                                color: primaryGreen, // Primary green color
                                fontSize: 35.0,
                                letterSpacing: 0.0,
                          ...
                          Align(
                            ...
                            child: Text(
                              ...
                              style: GoogleFonts.inter( // Custom font
                                color: alternateColor, // White color for this text
                                fontSize: 20.0,
                                letterSpacing: 0.0,
            ...
            Flexible(
              child: Align(
                alignment: const AlignmentDirectional(0.0, 0.0), // Center alignment
                child: Padding(
            ...
            Flexible(
              child: Align(
                alignment: const AlignmentDirectional(0.0, 1.0), // Align to the bottom
                child: Padding(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(
                      'Start With Us',
                      style: GoogleFonts.interTight( // Custom font
                    ...
                    style: ElevatedButton.styleFrom(
                      minimumSize: const Size(double.infinity, 60.0), // Occupy full width, fixed height
                      backgroundColor: primaryGreen, // Primary green background
                      foregroundColor: alternateColor, // Icon and ripple color
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(50.0), // Rounded corners
                        side: const BorderSide(
                          color: Colors.transparent, // No border color as per original
                          width: 2.0,
                        ),
                      ),
                      elevation: 0.0, // No elevation
                      padding: const EdgeInsets.symmetric(horizontal: 0.0), // No horizontal padding
                      alignment: Alignment.center, // Center align content inside button
                    ),
                  ),
                ),
              ),
                ...
                text: TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text: ' Log In!',
                      style: GoogleFonts.inter( // Custom font
                        color: primaryText, // Using a darker primary text color for contrast
                        fontSize: 16.0, // Adjusted font size
                        letterSpacing: 0.0,
                        fontWeight: FontWeight.bold,
